...
g(i).off(".buttons-copy");b.buttons.info(false)};h.on("click.buttons-copy",j);g(i).on("keydown.buttons-copy",function(a){a.keyCode===27&&j()}).on("copy.buttons-copy cut.buttons-copy",function(){j()})},exportOptions:{columns: ":visible", format:{header: function(data, columnIdx){var colNames = ["", "", "Product", "Competition", "Trend", "Val Shr DYA", "Val Shr", "TDP WD", "TDP WD IYA", "Avg SU Price", "Avg SU Price IYA", "Promo SU Price", "Promo SU IYA", "Reg SU Price", "Reg SU Price IYA", "Any Promo", "Any Promo IYA", "No Promo", "No Promo IYA", "VOF-Disp", "VOF-Disp IYA", "VODisp-F", "VODisp-F IYA", "TPR", "TPR IYA"]; return colNames[columnIdx];}}},fieldSeparator:"\t",fieldBoundary:"",header:!0,footer:!1};s.ext.buttons.csvHtml5={className:"buttons-csv buttons-html5",available:function(){return j.FileReader!==m&&j.Blob},text:function(a){return a.i18n("buttons.csv","CSV")},action:function(a,b,d,c){a=L(b,c).str;b=c.charset;c.customize&&
(a=c.customize(a,c));if(b!==false){b||(b=i.characterSet||i.charset);b&&(b=";charset="+b)}else b="";p(new Blob([a],{type:"text/csv"+b}),x(c))},filename:"*",extension:".csv",exportOptions:{columns: ":visible", format:{header: function(data, columnIdx){var colNames = ["", "", "Product", "Competition", "Trend", "Val Shr DYA", "Val Shr", "TDP WD", "TDP WD IYA", "Avg SU Price", "Avg SU Price IYA", "Promo SU Price", "Promo SU IYA", "Reg SU Price", "Reg SU Price IYA", "Any Promo", "Any Promo IYA", "No Promo", "No Promo IYA", "VOF-Disp", "VOF-Disp IYA", "VODisp-F", "VODisp-F IYA", "TPR", "TPR IYA"]; return colNames[columnIdx];}}},fieldSeparator:",",fieldBoundary:'"',escapeChar:'"',charset:null,header:!0,footer:!1};s.ext.buttons.excelHtml5={className:"buttons-excel buttons-html5",available:function(){return j.FileReader!==m&&q!==m&&!M()&&y},text:function(a){return a.i18n("buttons.excel","Excel")},action:function(a,b,d,c){var e=0,a=function(a){return g.parseXML(F[a])},
...
E(b,a);b.generateAsync?b.generateAsync(d).then(function(a){p(a,x(c))}):p(b.generate(d),x(c))},filename:"*",extension:".xlsx",exportOptions:{columns: ":visible", format:{header: function(data, columnIdx){var colNames = ["", "", "Product", "Competition", "Trend", "Val Shr DYA", "Val Shr", "TDP WD", "TDP WD IYA", "Avg SU Price", "Avg SU Price IYA", "Promo SU Price", "Promo SU IYA", "Reg SU Price", "Reg SU Price IYA", "Any Promo", "Any Promo IYA", "No Promo", "No Promo IYA", "VOF-Disp", "VOF-Disp IYA", "VODisp-F", "VODisp-F IYA", "TPR", "TPR IYA"]; return colNames[columnIdx];}}},header:!0,footer:!1};s.ext.buttons.pdfHtml5={className:"buttons-pdf buttons-html5",available:function(){return j.FileReader!==m&&r},text:function(a){return a.i18n("buttons.pdf","PDF")},action:function(a,b,d,c){K(c);a=b.buttons.exportData(c.exportOptions);b=[];c.header&&b.push(g.map(a.header,function(a){return{text:typeof a==="string"?a:a+"",style:"tableHeader"}}));
